...
class cnn:
	...
	def apply_conv1d(self, x, filter_width, in_channels, out_channels, kernel_stride):
	...
	# API: must ksize[0]=ksize[4]=1, strides[0]=strides[4]=1
		return tf.nn.max_pool2d(x, ksize=[1, pooling_height, pooling_width, 1], strides=[1, pooling_stride, pooling_stride, 1], padding=self.padding)

	def apply_conv2d(self, x, filter_height, filter_width, in_channels, out_channels, kernel_stride):
	...
	def apply_fully_connect(self, x, x_size, fc_size):
