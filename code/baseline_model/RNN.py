...
dataset_dir = "d:/ToRNeuralNetork/Cascade-Parallel-master/1D_CNN/raw_data/window_1D/"
...
output_dir 	= "win_"+str(window_size)+"_"+str(begin_subject)+"_"+str(end_subject)+"_fc_"+str(n_fc_in)+"_RNN"+str(n_lstm_layers)+"_fc_"+str(n_fc_out)+"_"+regularization_method+"_"+str(train_test_split*100)+"_hs_"+str(n_hidden_state)
output_file = "win_"+str(window_size)+"_"+str(begin_subject)+"_"+str(end_subject)+"_fc_"+str(n_fc_in)+"_RNN"+str(n_lstm_layers)+"_fc_"+str(n_fc_out)+"_"+regularization_method+"_"+str(train_test_split*100)+"_hs_"+str(n_hidden_state)
...
###########################################################################
	...
	writer = pd.ExcelWriter("./result/"+output_dir+"/"+output_file+".xlsx") # pylint: disable=abstract-class-instantiated
