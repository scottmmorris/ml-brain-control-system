...
# dataset directory
dataset_dir = "d:/ToRNeuralNetork/Cascade-Parallel-master/2D_CNN/raw_data/"

# load dataset and label
with open(dataset_dir+str(begin_subject)+"_"+str(end_subject)+"_shuffle_dataset_2D.pkl", "rb") as fp:
  	datasets = pickle.load(fp)
with open(dataset_dir+str(begin_subject)+"_"+str(end_subject)+"_shuffle_labels_2D.pkl", "rb") as fp:
