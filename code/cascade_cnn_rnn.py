...
output_file = "cascade_model_07032021"
...
with open(dataset_dir+"1_108_shuffle_dataset_win_10.pkl", "rb") as fp:
  	datasets = pickle.load(fp)
# with open(dataset_dir+"top108_shuffle_labels_3D_win_10.pkl", "rb") as fp:
with open(dataset_dir+"1_108_shuffle_labels_win_10.pkl", "rb") as fp:
...
init_state = lstm_cell.zero_state(accuracy_batch_size, dtype=tf.float32)
