...
with open("D:/ToRNeuralNetork/Cascade-Parallel-master/conv_3l_win_10_108_fc_rnn2_fc_1024_N_summary_075_train_posibility_roc/confusion_matrix.pkl", "rb") as fp:
...
plt.show()
f.savefig('D:/ToRNeuralNetork/casecade_cm.png')
# 
...
# with open("d:/ToRNeuralNetork/Cascade-Parallel-master/1d_conv_3l_1_50_fc_1024_dropout_75.0/confusion_matrix.pkl", "rb") as fp:
#   	parallel_cm = pickle.load(fp)
# parallel_cm=parallel_cm.astype(np.float64)
# parallel_cm[0]=parallel_cm[0]/sum(parallel_cm[0])
# parallel_cm[1]=parallel_cm[1]/sum(parallel_cm[1])
...
# plt.show()
# f.savefig('d:/ToRNeuralNetork/scott_real_model/parallel_3D_cm.png')
